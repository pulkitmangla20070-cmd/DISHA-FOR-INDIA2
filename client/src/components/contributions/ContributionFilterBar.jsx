...
const ContributionFilterBar = ({ filters, onFilterChange, categories = [] }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--color-body)', fontWeight: 600, fontSize: '0.85rem' }}>
