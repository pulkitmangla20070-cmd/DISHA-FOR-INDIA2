    ...
    >
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '4rem 1.5rem', position: 'relative', zIndex: 2, width: '100%' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
          ...
          >
            <button onClick={onStartContributing} className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.875rem 2rem', fontSize: '1rem' }}>
              Start Contributing <ArrowRight size={18} />
            </button>
            <Link to="/programs" className="btn btn-secondary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.875rem 2rem', fontSize: '1rem', color: 'white', borderColor: 'rgba(255,255,255,0.3)' }}>
              Browse Programs
            </Link>
          </motion.div>
          ...
          <motion.div
            ...
            style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '2rem', marginTop: '3rem', color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem', fontWeight: 500 }}
          >
